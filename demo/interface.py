...
welcome_message = """
  ...
  Hint: The knowledge base of the LLM has been loaded with a pre-existing vectorstore of [resumes](https://github.com/Fardeen627/ai-resume-screening/blob/main/data/main-data/synthetic-resumes.csv) to be used right away.

  In addition, you may also find example job descriptions to test [here](https://github.com/Fardeen627/ai-resume-screening/blob/main/data/supplementary-data/job_title_des.csv).
...
about_message = """
  ...
  The program is very much a work in progress. I really appreciate any contribution or feedback on [GitHub](https://github.com/Fardeen627/ai-resume-screening).
...
with st.sidebar:
  ...
  st.markdown("Made by [Fardeen Akhtar](https://github.com/Fardeen627)")
